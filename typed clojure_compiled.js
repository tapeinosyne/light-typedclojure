...
lt.plugins.typedclojure.move_top = (function move_top(p__11477,dir){var map__11480 = p__11477;var map__11480__$1 = ((cljs.core.seq_QMARK_.call(null,map__11480))?cljs.core.apply.call(null,cljs.core.hash_map,map__11480):map__11480);var orig = map__11480__$1;var loc = cljs.core.get.call(null,map__11480__$1,new cljs.core.Keyword(null,"loc","loc",1014011570));var ed = cljs.core.get.call(null,map__11480__$1,new cljs.core.Keyword(null,"ed","ed",1013907473));var vec__11481 = lt.plugins.paredit.form_boundary.call(null,ed,loc,null);var start = cljs.core.nth.call(null,vec__11481,0,null);var end = cljs.core.nth.call(null,vec__11481,1,null);if(cljs.core.truth_((function (){var and__6796__auto__ = start;if(cljs.core.truth_(and__6796__auto__))
{return end;
} else
...
lt.plugins.typedclojure.form_QMARK_ = (function form_QMARK_(e,loc){var vec__11483 = lt.plugins.paredit.form_boundary.call(null,e,loc,null);var start = cljs.core.nth.call(null,vec__11483,0,null);var end = cljs.core.nth.call(null,vec__11483,1,null);if((cljs.core.not_EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,null], null),lt.plugins.paredit.form_boundary.call(null,e,loc,null))) || (cljs.core.not_EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,null], null),lt.plugins.paredit.form_boundary.call(null,e,lt.objs.editor.adjust_loc.call(null,loc,-1),null))) || (cljs.core.not_EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,null], null),lt.plugins.paredit.form_boundary.call(null,e,lt.objs.editor.adjust_loc.call(null,loc,1),null))))
{return true;
} else
{return false;
}
...
{var ed = temp__4092__auto__;if(cljs.core.truth_((function (){var or__6808__auto__ = cljs.core.not.call(null,new cljs.core.Keyword("lt.plugins.typedclojure","orig-pos","lt.plugins.typedclojure/orig-pos",3684609387).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,ed)));if(or__6808__auto__)
...
lt.plugins.typedclojure.check_form2 = (function check_form2(s){return [cljs.core.str("(if-let [res (clojure.core.typed/check-form-info '"),cljs.core.str(s),cljs.core.str(")] (with-out-str (clojure.pprint/write res)))")].join('');
});
